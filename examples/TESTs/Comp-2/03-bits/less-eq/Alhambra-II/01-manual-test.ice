{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7239a59f-151b-42cc-9a54-bdcc0c02cfc0",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "a8ad75ca-ecc7-4012-8be6-78daf33e4f88",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "0",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Less-eq-3bits: Manual testing",
            "readonly": true
          },
          "position": {
            "x": 144,
        ...
        {
          "id": "b5490b69-df19-474f-b777-8cbfa28a29fd",
        ...
        {
          "id": "8cc6318e-965d-42ef-9976-57cb5d432a7d",
          "type": "00820458fb26f16b964d5c5cd6aaad7a1650933f",
          "position": {
            "x": 680,
            "y": 440
          },
        ...
        {
          "id": "1d2f7b62-83f2-42f8-ac07-d0bb787ffe0c",
      ...
      "wires": [
        {
          "source": {
            "block": "8cc6318e-965d-42ef-9976-57cb5d432a7d",
        ...
        {
          "source": {
            "block": "a8ad75ca-ecc7-4012-8be6-78daf33e4f88",
            "port": "constant-out"
          },
          "target": {
            "block": "1d2f7b62-83f2-42f8-ac07-d0bb787ffe0c",
        ...
        },
        {
          ...
          "target": {
            "block": "b5490b69-df19-474f-b777-8cbfa28a29fd",
        ...
        },
        {
          ...
          "target": {
            "block": "7239a59f-151b-42cc-9a54-bdcc0c02cfc0",
            "port": "in"
          },
          "size": 3
        },
        {
          ...
          "target": {
            "block": "8cc6318e-965d-42ef-9976-57cb5d432a7d",
            "port": "27121e8b-a2ce-4184-9eac-765ff39c55ee"
          },
          "size": 3
        },
        {
          ...
          "target": {
            "block": "8cc6318e-965d-42ef-9976-57cb5d432a7d",
            "port": "0187944b-253c-45bc-a5a4-447a098a7742"
          },
          "size": 3
        }
      ]
  ...
  "dependencies": {
    ...
    "00820458fb26f16b964d5c5cd6aaad7a1650933f": {
      "package": {
        "name": "less-eq-3bit",
        "version": "0.1",
        "description": "Less-eq-3bit: Comparator of two 3-bit numbers",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "c67f9a81-9aa1-4dc5-918b-33b5784518ba",
              "type": "basic.outputLabel",
              "data": {
                "name": "a",
                "range": "[2:0]",
            ...
            {
              "id": "27121e8b-a2ce-4184-9eac-765ff39c55ee",
              "type": "basic.input",
              "data": {
                "name": "a",
                "virtual": true,
            ...
            {
              "id": "d7ece0b4-0c67-4ee7-99f0-579c0fe7f817",
              "type": "basic.inputLabel",
              "data": {
                "name": "a",
                "range": "[2:0]",
            ...
            {
              "id": "674a1f41-b1b8-448a-a73f-f9fc93070cd1",
              "type": "basic.outputLabel",
              "data": {
                "name": "b",
                "range": "[2:0]",
            ...
            {
              "id": "1b93f3f3-4485-4b37-98f0-885d663698b8",
              "type": "basic.outputLabel",
              "data": {
                "name": "a",
                "range": "[2:0]",
            ...
            {
              "id": "0187944b-253c-45bc-a5a4-447a098a7742",
              "type": "basic.input",
              "data": {
                "name": "b",
                "virtual": true,
            ...
            {
              "id": "ab7a4981-46e2-4fd3-889f-444975115ef5",
              "type": "basic.inputLabel",
              "data": {
                "name": "b",
                "range": "[2:0]",
            ...
            {
              "id": "a76b8d2c-f748-4caf-8496-1cf9a4b0bbe5",
              "type": "basic.outputLabel",
              "data": {
                "name": "b",
                "range": "[2:0]",
            ...
            {
              "id": "0270db02-6733-4af1-b357-04b30dc0d06f",
            ...
            {
              "id": "05df06de-6cd0-493b-bc31-03fb9d096835",
          ...
          "wires": [
            {
              "source": {
                "block": "27121e8b-a2ce-4184-9eac-765ff39c55ee",
                "port": "out"
              },
              "target": {
                "block": "d7ece0b4-0c67-4ee7-99f0-579c0fe7f817",
                "port": "inlabel"
              },
              "size": 3
            },
            {
              "source": {
                "block": "0187944b-253c-45bc-a5a4-447a098a7742",
                "port": "out"
              },
              "target": {
                "block": "ab7a4981-46e2-4fd3-889f-444975115ef5",
                "port": "inlabel"
              },
              "size": 3
            },
            {
              "source": {
                "block": "c67f9a81-9aa1-4dc5-918b-33b5784518ba",
                "port": "outlabel"
              },
              "target": {
                "block": "05df06de-6cd0-493b-bc31-03fb9d096835",
            ...
            {
              "source": {
                "block": "674a1f41-b1b8-448a-a73f-f9fc93070cd1",
                "port": "outlabel"
              },
              "target": {
                "block": "05df06de-6cd0-493b-bc31-03fb9d096835",
            ...
            {
              "source": {
                "block": "1b93f3f3-4485-4b37-98f0-885d663698b8",
                "port": "outlabel"
              },
              "target": {
                "block": "0270db02-6733-4af1-b357-04b30dc0d06f",
            ...
            {
              "source": {
                "block": "a76b8d2c-f748-4caf-8496-1cf9a4b0bbe5",
                "port": "outlabel"
              },
              "target": {
                "block": "0270db02-6733-4af1-b357-04b30dc0d06f",
